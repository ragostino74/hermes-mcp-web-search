#!/usr/bin/env python3
"""
Hermes MCP Server v1.5.3 — Scientific Computing Suite (SymPy + NumPy/SciPy)
...
_BRIDGE_PORT = int(os.environ.get("HERMES_MCP_BRIDGE_PORT", "18762"))
